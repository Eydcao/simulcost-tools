...
from .pressure_updater import RedBlackSorPressureUpdater, ResidualBasedSorPressureUpdater
...
class FluidSimulator:
    ...
    @staticmethod
    def create(num, resolution, dt, dx, re, vor_eps, scheme, relaxation_factor=1.3, residual_threshold=1e-6):
        ...
        pressure_updater = ResidualBasedSorPressureUpdater(
            boundary_condition, dt, dx, relaxation_factor=relaxation_factor, residual_threshold=residual_threshold
        )
