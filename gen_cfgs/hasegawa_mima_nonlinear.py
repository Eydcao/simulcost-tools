...
def create_hasegawa_nonlinear_profiles(case_configs, base_profile_path):
    """
    Create multiple Hasegawa-Mima nonlinear profiles based on the p1 base profile.
    ...
    for i in range(num_profiles):
        ...
        update_params = {
            "case": config["case"],
            "dump_dir": f'"sim_res/hasegawa_mima_nonlinear/{profile_name}"',
        }
        ...
        for line in lines:
            ...
            if param_match:
                ...
                if param_name in update_params:
                    new_value = update_params[param_name]
...
if __name__ == "__main__":
    # Create Hasegawa-Mima nonlinear profiles for several initial condition cases
    # Note: p1 = monopole (base profile)
    case_configs = [
        {"case": "dipole"},  # p2
        {"case": "sinusoidal"},  # p3
        {"case": "sin_x_gauss_y"},  # p4
        {"case": "gauss_x_sin_y"},  # p5
    ]
