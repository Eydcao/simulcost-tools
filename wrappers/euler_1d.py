...
def _find_runner_path():
    """Automatically find the correct path to euler_1d.py runner."""
    ...
    if cwd.endswith('SimulCost-Bench'):
        possible_paths.extend([
            "costsci_tools/runners/euler_1d.py",
            "runners/euler_1d.py"
        ])
    ...
    raise FileNotFoundError(
        f"Could not find euler_1d.py runner in any expected location.\n"
