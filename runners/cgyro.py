...
def main(cfg):
    ...
    try:
        ...
        # Zip temporary files generated by CGYRO
            ...
            with tarfile.open(archive_name, "w:gz") as tar:
                for file_path in zip_files:
                    if os.path.exists(file_path):
                        ...
                        # arcname can be used to specify an alternative name/path within the archive
        ...
        # Delete temporary files generated by CGYRO (only after tar created)
        for file_path in zip_files:
            try:
                os.remove(file_path)
